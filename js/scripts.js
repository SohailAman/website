(function ($) {
  ...
  function pageLoader() {
    ...
    if (siteLoader == true) {
      ...
      $(".apl-count").append(
        '<div class="apl-num apl-num-1"></div><div class="apl-num apl-num-2"></div><div class="apl-num apl-num-3"></div>'
      );
  ...
  function mouseCursor() {
    if (pageCursor == true) {
      ...
      function cursorHovers() {
        ...
        var projectHovers = $(
          ".ar-work, .fw-project, .cs-title, .sl-project, .wall-project, .alioth-single-project, .aw-project"
        );
        ...
        var borderHovers = $(
          ".menu-toggle, .fs-prev, .fs-next, .ss1-dots, .ss2-dot, .ss2-prev, .ss2-next, .ss1-prev, .ss1-next, .a-plus-button, .scroll-notice, .a-test-next, .a-test-prev, .cart-button, .cpq-reduce, .cpq-increase, .swiper-pagination-bullet"
        );
        ...
        var dotHovers = $(
          "ul.main-menu a, .a-button, .a-client, .fs-button, .alioth-latest-posts .post, .field-wrap"
        );
  ...
  function fullscreenNavigation() {
    if ($(".site-navigation").hasClass("fullscreen")) {
      ...
      menuItemHasSub.each(function () {
        let $this = $(this);
        $this.append(
          '<span class="sub-toggle"><span class="sub-togg-line"></span><span class="sub-togg-line"></span></span>'
        );
      });
      ...
      var socialListAnim = gsap.fromTo(
        ".social-list li a",
        {
          translateY: "100%",
          skewY: 10,
  ...
  function aliothProjectPage() {
    ...
    if (animate == true) {
      ...
      $(".tit_word, .project-other h5, .summ_line, .project-cat").wrapInner(
        "<span></span>"
      );
  ...
  function aliothShop() {
    ...
    product.each(function (i) {
      ...
      $this.append(
        '<div class="product-acts"><a href="#addtocart">Add To Cart</a></div>'
      );
  ...
  function showcaseFullscreenCarousel() {
    ...
    projects.each(function (i) {
      ...
      $(".cs-images").append(
        '<div class="cs-project-image image_' + i + '">' + image + "</div>"
      );
      ...
      gsap.to(imgWrap, {
        ...
        onStart: function () {
          gsap.set(imgWrap, {
            left: "unset",
            right: 0,
            opacity: 0, // Add initial opacity of 0
          });
        },
        onComplete: function () {
          gsap.to(imgWrap, {
            duration: 3,
            opacity: 1, // Fade in image by animating the opacity to 1
          });
        },
      });
    ...
    project.on("mouseleave", function () {
      ...
      gsap.to(imgWrap, {
        ...
        onComplete: function () {
          gsap.to(imgWrap, {
            duration: 0.5,
            opacity: 0, // Fade out image by animating the opacity to 0
            onComplete: function () {
              gsap.set(imgWrap, {
                opacity: 1, // Reset the opacity to 1 at the end of the animation
                width: "0%", // Reset the width to 0% after the fade-out animation completes
              });
            },
          });
        },
  ...
  function showcaseWall() {
    var wallProject = $(".wall-project"),
      ...
      wallProjectsBottom = document.getElementsByClassName(
  ...
  function aliothLinkedText() {
    ...
    linkedText.each(function () {
      ...
      links.each(function () {
        ...
        $this.append(
          '<span class="link-target"><span>' + targetTitle + "</span></span>"
        );
      });
  ...
  function aliothTeamCarousel() {
    ...
    aliothTeam.each(function () {
      ...
      member.on("mouseenter", function () {
        ...
        var socialsAnim = gsap.to(icons, 0.4, {
          x: 0,
          opacity: 1,
          stagger: 0.1,
          overwrite: true,
  ...
  function aliothShowcaseCarousel() {
    ...
    var mobileQuery = window.matchMedia("(max-width: 450px)"),
      tabletQuery = window.matchMedia(
        "(min-width: 450px) and (max-width: 900px)"
      );
  ...
  function aliothShowcaseSlideV2() {
    ...
    ss2Project.each(function (i) {
      ...
      $(".ss2-back-texts").append(
        '<div class="ss2-back-text back_' + i + '">' + title.text() + "</div>"
      );
    ...
    var rule = CSSRulePlugin.getRule(
      ".portfolio-showcaseCheck.showcase-slideshow-v2::before"
    ); //get the rule
  ...
  function showcaseOpenings() {
    ...
    if (showcaseCheck.length > 0) {
      if (showcaseCheck.hasClass("showcase-list")) {
        ...
        ssWelcome.fromTo(
          ".ss1-dots .swiper-pagination-bullet",
          1.5,
          {
            opacity: 0,
            x: 50,
  ...
  var trans = $(".alioth-page-transitions"),
    ...
    bg = $(".apt-bg"),
    menuOv = CSSRulePlugin.getRule(
      ".site-header.fullscreen_menu.menu-has-open::before"
    ),
    menuBackOv = CSSRulePlugin.getRule(
            ...
            if (siteHeader.hasClass("menu-has-open")) {
              ...
              gsap.to(menuOv, 0.75, {
                ...
                onComplete: function () {
                  ...
                  $(".site-navigation, .header-wrapper").removeClass(
                    "menu-opened"
                  );
